...
final Map<String, Uri> urlToTechStack = {
  ...
  "android development":
      Uri.parse("https://en.wikipedia.org/wiki/Android_software_development"),
  "backend development":
      Uri.parse("https://en.wikipedia.org/wiki/Back-end_web_development"),
  "frontend development":
      Uri.parse("https://en.wikipedia.org/wiki/Front-end_web_development"),
  "dart":
